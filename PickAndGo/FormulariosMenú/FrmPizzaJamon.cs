...
{
    public partial class FrmPizzaJamon : MetroFramework.Forms.MetroForm
    {
        public FrmPizzaJamon()
        {
            InitializeComponent();
        }

        private void FrmPizzaJamon_Load(object sender, EventArgs e)
        {
        ...
        {
            Comida comidaSeleccionada = new Comida(201, "Pizza Jamon", 180.00);
