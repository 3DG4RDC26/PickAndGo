...
{
    public partial class FrmDelValleLimon : MetroFramework.Forms.MetroForm
    {
        public FrmDelValleLimon()
        {
            InitializeComponent();
        }
        ...
        {
            Comida comidaSeleccionada = new Comida(004, "DelValle Limon", 45.00);
